...
@php
    $dataId = Auth::user()->id;
    $userData = App\Models\User::find($dataId);
@endphp
            <div class="dropdown d-inline-block user-dropdown">
                <button type="button" class="btn header-item waves-effect" id="page-header-user-dropdown"
                    data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    <img class="rounded-circle header-profile-user" src="{{ (!empty($userData->profile_image))? url('upload/admin_images/'.$userData->profile_image) : url('logo/no_image.jpg')  }}"
                        alt="Header Avatar">
