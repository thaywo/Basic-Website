                    ...
                    <div class="services__item">
                        ...
                        <div class="services__content">
                            <div class="services__icon">
                                ...
                                <img class="dark" src="a{{ asset('frontendssets/img/icons/services_icon04.png') }}" alt="">
                            </div>
                    ...
                    <div class="row gx-0 justify-content-center">
                        <div class="col">
                            <div class="portfolio__active">
                                ...
                                <div class="portfolio__item">
                                    <div class="portfolio__thumb">
                                        <img src="{{ asset('frontenddassets/img/portfolio/portfolio_img04.jpg') }}" alt="">
                                    </div>
                                    <div class="portfolio__overlay__content">
                    ...
                    <div class="row gx-0 justify-content-center">
                        <div class="col">
                            <div class="portfolio__active">
                                ...
                                <div class="portfolio__item">
                                    <div class="portfolio__thumb">
                                        <img src="{{ asset('frontend/assets/img/portfolio/portfolio_img02.') }}" alt="">
                                    </div>
                                    <div class="portfolio__overlay__content">
                                        <span>Web Design</span>
                                        <h4 class="title"><a href="portfolio-details.html">Banking Management System</a></h4>
